...
from main.models import listing as Listing, LikedListing
    ...
    if request.method == 'POST':
        ...
        if login_form.is_valid():
            ...
            if user is not None:
                ...
                messages.error(request, f'An error occured while logging in, please try again')
        else:
                messages.error(request, f'An error occured while logging in, please try again')        
...
class RegisterView(View):
    ...
    def post(self, request):
        ...
        if register_form.is_valid():
            ...
            messages.error(request, f'An error occurred while registering, please try again')
            render(request, 'views/register.html', {'register_form': register_form})
